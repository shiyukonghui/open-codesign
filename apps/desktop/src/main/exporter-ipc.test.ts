...
describe('parseRequest', () => {
  ...
  it('accepts workspace source context for local asset exports', () => {
    ...
    expect(normalizePathSeparators(assetOptions.assetRootPath as string)).toContain('/workspace');
    expect(assetOptions.assetBasePath).toBeDefined();
    expect(normalizePathSeparators(assetOptions.assetBasePath as string)).toContain(
  ...
  it('normalizes backslash sourcePath separators before resolving assets', () => {
    ...
    expect(normalizePathSeparators(assetOptions2.assetBasePath as string)).toContain(
      '/workspace/screens/home',
    );
